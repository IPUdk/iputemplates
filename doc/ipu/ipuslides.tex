...
\testcolor{ipulightgreen}
\testcolor{ipugrey}    
\testcolor{ipulightgrey}
\testcolor{ipugreen}   
\testcolor{ipupurple}  
\testcolor{ipuwhite}
\testcolor{ipublack}
\testcolor{ipuviridis1}
\testcolor{ipuviridis2}
\testcolor{ipuviridis3}
\testcolor{ipuviridis4}
